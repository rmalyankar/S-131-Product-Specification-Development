...
[[fig_13.1]]
.Components and associated metadata for the S-131 exchange set (S-100 Figure 17-2)
image::S-131&#32;ExchangeSet.png[]
...
Each Exchange Set consists of one or more MHI datasets and a single Exchange Catalogue XML file containing
...
* The first three characters are always "131" and identify the dataset as an S-131 dataset.
...
footnote:[The languages list, other dictionaries, language packs, and portrayal catalogue files are expected to be distributed separately in special exchange sets and should not be included in ordinary MHI exchange sets.]
...
| HTM | HTML files must only include inline or embedded Cascading Style
