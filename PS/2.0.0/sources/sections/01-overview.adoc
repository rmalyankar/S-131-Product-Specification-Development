...
* [[[IHO_S_158_131,nofetch(IHO S-158:131)]]] S-158:131: Marine Harbour Infrastructure Validation Checks, Edition 1.0.0, International Hydrographic Organization. (In preparation.)

[[sec_1.3.2]]
[bibliography]
==== Informative

EDITOR: FIPS 186 has undergone multiple updates, the latest is 186-5 - any reason to keep citing FIPS 186?
...
* [[[IHO_S_101,IHO S-101]]] S-101: Electronic Navigational Chart Product Specification Edition 2.0.0, December 2024.

* [[[ITPCO,nofetch((PIM)ITPCO)]]] ITPCO: Port Information Manual, Edition 3.02, Industry Partners, Standards Partners and Endorsers of the ITPCO, IHMA, 
IAPH and UKHO. International Taskforce Port Call Optimization (ITPCO), January 2021 (https://portcalloptimization.org/images/Port%20Information%20Manual%203.02.pdf).

* [[[ISO_10646_1,ISO/IEC 10646-1:2000]]] 
...
**alarm**s, **warning**s and **caution**s.
...
Description of a set of objects that share the same *attribute*s,
operations, methods, *relationship*s, and semantics.
...
*Coordinate* system that is related to an object by a
datum.
...
EDITOR: Removed "ecdis" and "enc" from Terms, they are defined as Abbreviations, and the definition of ECDIS references the obsolete "SENC"
...
*Relationship* that links instances of one *feature*
...
types, **feature attribute**s, and **feature association**s occurring in one or more sets of geographic data.
...
NOTE&#58; The boundary of a surface is the set of oriented, closed **curve**s
...
+
--
*Description:*:: Global coverage of ports and harbours and their environs. +
...
*Title:*:: Marine Harbour Infrastructure Product Specification
